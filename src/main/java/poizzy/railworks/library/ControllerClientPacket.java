...
public class ControllerClientPacket extends Packet {
    @TagField
    public World world;
    @TagField
    public Vec3i pos;
    ...
    public ControllerClientPacket() {
    }

    public ControllerClientPacket(World world, Vec3i pos, Map<Integer, String> redstoneLevels) {
        this.world = world;
        this.pos = pos;
